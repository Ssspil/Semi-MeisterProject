	...
	<div class="outer">
		...
		<table class="tb1">
			...
			<tr>
				...
				<td>
					<textarea name="price" id="textarea1" style="resize: none;" placeholder="가격 정보를 입력해주세요." maxlength="4000" required></textarea>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<textarea id="textarea3" name="sellRegulation" style="resize: none;" placeholder="취소 및 환불 규정을 작성해주세요." maxlength="4000" required></textarea>
				</td>
			</tr>
		</table>
