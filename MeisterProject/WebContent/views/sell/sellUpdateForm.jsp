	...
	<div class="outer">
		...
		<table class="tb1">
				...
				<script>
					$(function(){
						$("#update-form option").each(function(){
							if($(this).text() == "<%= s.getInterestName() %>"){
								$(this).attr("selected",true);
							}
							if($(this).text() == "<%= s.getLocalNo() %>"){
								$(this).attr("selected",true);
							}
						})
					})
			...
			<tr>
				...
				<td>
				<input name="sellTitle" type="text" id="input1" placeholder="등록할 제목을 입력해주세요" required value="<%= s.getSellTitle() %>">
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
				<input name="sellContent" type="text" id="input2" placeholder="작성할 내용을 입력해주세요" required value="<%= s.getSellContent() %>">
				</td>			
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<textarea name="price" id="textarea1" style="resize: none;" placeholder="가격 정보를 입력해주세요." required><%= s.getPrice() %></textarea>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<textarea id="textarea3" name="sellRegulation" style="resize: none;" placeholder="취소 및 환불 규정을 작성해주세요." required><%= s.getSellRegulation() %></textarea>
				</td>
			</tr>
		</table>
		...
		<button id="btn1" type="submit" class="btn btn-warning" onclick="submitLogin();" style="text-align:center">수정하기</button>
		</form>
	</div>
