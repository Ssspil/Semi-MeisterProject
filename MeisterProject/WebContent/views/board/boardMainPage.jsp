...
<body>
   ...
   <div class="bodyWrite_wrap">
      <div id="body2-2" align="right">
         <form action="<%=contextPath%>/enrollForm.bo" class="btn btn-secondary"
            style="background-color: orange;">
            <button type="submit"><i class="bi bi-pencil-square "> 글작성 </i></button> 
            <input type="hidden" id="type" name="type" value="1" style="height:35px;">
            </form>
      </div>
      <hr>
   </div>
   <div class="body2" id="geBody">
      <div id="body2-1">
         ...
         %>
         <div id="body2-4" class="board board<%=i%> <%=i > 4 ? "hide" : ""%>">
            <hr>
